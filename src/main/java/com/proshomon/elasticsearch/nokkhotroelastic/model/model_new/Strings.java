...
public class Strings {
    ...
    /**
     * Error message shown when service provider not found
     */
	...
	/**
	 * Error message shown when service information provided is does not match any required template
	 * e.g. A service marked as done in existing prescription
	 */
